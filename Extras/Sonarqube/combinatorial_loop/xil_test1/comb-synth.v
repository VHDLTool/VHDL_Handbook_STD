...
// Date        : Tue Oct 31 10:07:50 2023
// Host        : Albertine running 64-bit Ubuntu 22.04.3 LTS
// Command     : write_verilog ./xil_test1/comb-synth.v
// Design      : test1
...
module test1
  ...
  wire \o_data_OBUF[3]_inst_i_1_n_1 ;
  wire \o_data_OBUF[3]_inst_i_1_n_2 ;
  wire \o_data_OBUF[3]_inst_i_1_n_3 ;
  ...
  wire \o_data_OBUF[7]_inst_i_1_n_1 ;
  wire \o_data_OBUF[7]_inst_i_1_n_2 ;
  wire \o_data_OBUF[7]_inst_i_1_n_3 ;
  ...
  CARRY4 \o_data_OBUF[3]_inst_i_1 
       (.CI(\<const0> ),
        .CO({\o_data_OBUF[3]_inst_i_1_n_0 ,\o_data_OBUF[3]_inst_i_1_n_1 ,\o_data_OBUF[3]_inst_i_1_n_2 ,\o_data_OBUF[3]_inst_i_1_n_3 }),
        .CYINIT(\<const0> ),
        .DI(o_data_OBUF[3:0]),
        .O(o_data_OBUF[3:0]),
  ...
  CARRY4 \o_data_OBUF[7]_inst_i_1 
       (.CI(\o_data_OBUF[3]_inst_i_1_n_0 ),
        .CO({\o_data_OBUF[7]_inst_i_1_n_1 ,\o_data_OBUF[7]_inst_i_1_n_2 ,\o_data_OBUF[7]_inst_i_1_n_3 }),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,o_data_OBUF[6:4]}),
        .O(o_data_OBUF[7:4]),
