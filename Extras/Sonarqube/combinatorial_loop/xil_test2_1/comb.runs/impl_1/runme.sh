...
HD_PWD='/home/flo/FLORENT/GIT/VHDL_Handbook_STD/Extras/Sonarqube/combinatorial_loop/xil_test2_1/comb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test2_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test2_1.tcl -notrace
