...
HD_PWD='/home/flo/FLORENT/GIT/VHDL_Handbook_STD/Extras/Sonarqube/combinatorial_loop/xil_test2_1/comb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test2_1.tcl
